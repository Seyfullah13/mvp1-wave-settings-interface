...
Route::group(['middleware' => 'auth'], function () {
    Route::get('/settings', function () {
        return view('themes.tailwind.settings.partials.settings');
    });
    ...
    Route::get('notifications', '\Wave\Http\Controllers\NotificationController@index')->name('wave.notifications');
    Route::post('notification/read/{id}', '\Wave\Http\Controllers\NotificationController@read')->name('wave.notification.read');
