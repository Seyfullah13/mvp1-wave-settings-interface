...
class DatabaseSeeder extends Seeder
{
  ...
  public function run()
  {
    ...
    // $this->call(StatusCorrespondanceSeeder::class);
    // $this->call(PropertyFeesSeeder::class);
    // $this->call(FeesPropertySeeder::class);
    $this->call(BookingSeeder::class);
    $this->call(ReviewTableSeeder::class);
    $this->call(ConversationsTableSeeder::class);
    $this->call(ContactConversationTableSeeder::class);
    ...
    // * commented
    // $this->call(IcalSeeder::class);
    $this->call(MyUserRolesSeeder::class);
