    <div class="h-full bg-white rounded-lg shadow dark:bg-gray-800 p-4 md:p-6">
        ...
        <div class="flex justify-between mb-3">
            <div class="flex justify-center items-center">
                <h5 class="text-xl font-bold leading-none text-gray-900 dark:text-white pe-1">Bookings by channel</h5>
                {{-- * info icon --}}
    ...
    @script
        <script>
            ...
            options = getDonutOptions(data);
            // console.log("chart rendering ..");
            donut_chart = new ApexCharts(document.getElementById("donut-chart"), options);
            donut_chart.render();

            $wire.on('donut-update', (event_data) => {
                ...
                // console.log("donut-update data", data);
                const options = getDonutOptions(data);
                donut_chart.updateOptions(options, animate = true, redrawPaths = false, updateSyncedCharts = false);
            });

            function getDonutOptions(data) {
                return {
                    series: data.series,
                    colors: data.colors,
                    chart: {
