...
<div class="relative px-8 pt-8 pb-20 mx-auto xl:px-5 max-w-7xl sm:px-6 lg:pt-10 lg:pb-28">
    ...
    <div class="relative mx-auto max-w-7xl">
        <div class="flex flex-col justify-start">
            ...
            <ul
                class="flex self-start inline w-auto px-3 py-1 mt-3 text-xs font-medium text-gray-600 bg-blue-100 rounded-md">
                ...
                <li
                    ...
                    <a href="{{ route('wave.blog.category', $cat->slug) }}">{{ $cat->name }}</a>
                </li>
                @if(!$loop->last)
                    ...
                    <div class="flex-1">
                        ...
                        <a href="{{ $post->link() }}" class="block">
                            <p class="mt-3 text-base leading-6 text-gray-500">
                                {{ substr(strip_tags($post->body), 0, 200) }}@if(strlen(strip_tags($post->body)) >
                                200){{ '...' }}@endif
                            </p>
                        </a>
                    </div>
